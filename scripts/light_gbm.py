...
def DO(frm,to,nchunk,fileno):
    ...
    # Load data 
    train_df = pd.read_pickle('../input/new_features_v11/train.pkl')
    val_df = pd.read_pickle('../input/new_features_v11/val.pkl')
    test_df = pd.read_pickle('../input/new_features_v11/test.pkl')
    ...
    params = {
        ...
        'num_leaves': 31,  # 2^max_depth - 1 # was 7
        'max_depth': -1,  # -1 means no limit
    ...
    (bst,best_iteration) = lgb_modelfit_nocv(params, 
                            ...
                            objective='binary', 
                            metrics='auc',
                            early_stopping_rounds=50, # was 30
                            verbose_eval=True, 
                            num_boost_round=10000, # was 1000
    ...
    sub.to_pickle('../input/new_features_v11/sub_test_suppl.pkl') 
    print("done...")
